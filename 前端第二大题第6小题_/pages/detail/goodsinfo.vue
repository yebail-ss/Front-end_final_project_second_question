		...
		<view class="index-goods" v-if="loadGoods">
			...
			<view class="goods_quan s-row">
				<view class="row getGoodsLink">
					<view class="is-col-16 money">
						...
						<view class="date-coupon">使用期限:2020.02.22-2020.02.23</view>
					</view>
			...
			<view class="goods_shop">
				<view class="info">
					<image
						lazy-load
						src="https://thirdqq.qlogo.cn/g?b=sdk&k=cL5LbJ95V4WibAOXD6GlCKw&s=640&t=1539235611"
						mode="widthFix"
						class="is-response"
					></image>
					<view class="shop-text">
						<view class="shop-title">MK-黎之恒</view>
